...
Hình dưới đây được lấy từ cuốn sách [Hadoop in practice - Second edition](https://github.com/MinhHuuNguyen/ai-lectures/blob/master/books/mathematics_for_machine_learning_deisenroth.pdf) của tác giả Alex Holmes, mô tả tổng quan về đặc điểm của hệ sinh thái Hadoop.
...
Hình dưới đây được lấy từ cuốn sách [Hadoop in practice - Second edition](https://github.com/MinhHuuNguyen/ai-lectures/blob/master/books/mathematics_for_machine_learning_deisenroth.pdf), giới thiệu về các thành phần trong hệ sinh thái Hadoop.
...
<img src="https://raw.githubusercontent.com/MinhHuuNguyen/data-engineer-lectures/refs/heads/master/3_hadoop_ecosystem/images/2-hdfs/architecture.jpeg" style="width: 1000px;"/>
...
<img src="https://raw.githubusercontent.com/MinhHuuNguyen/data-engineer-lectures/refs/heads/master/3_hadoop_ecosystem/images/3-map-reduce/architecture.jpeg" style="width: 1000px;"/>
...
<img src="https://raw.githubusercontent.com/MinhHuuNguyen/data-engineer-lectures/refs/heads/master/3_hadoop_ecosystem/images/4-yarn/architecture.jpeg" style="width: 1000px;"/>
...
Ví dụ: Sử dụng Pig để lọc các dòng log chứa từ "ERROR" từ file log:

```
logs = LOAD '/logs/access.log' USING TextLoader();
filtered = FILTER logs BY $0 MATCHES '.*ERROR.*';
STORE filtered INTO '/output/errors';
```

Pig ngày nay ít được dùng do Spark đã thay thế.
...
ZooKeeper là một dịch vụ phối hợp phân tán, cung cấp các chức năng như đồng bộ hóa, quản lý cấu hình và đặt tên trong môi trường phân tán.
