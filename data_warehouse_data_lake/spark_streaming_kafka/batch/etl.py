...
INPUT_PATH=config['DATALAKE']['HDFS_INPUT_PATH']
OUTPUT_PATH=config['DATALAKE']['HDFS_OUTPUT_PATH']
...
def process_song_data(spark, input_data, output_data):
    """
    Loads song data from HDSF location 
...
def process_log_data(spark, input_data, output_data):
    """
    Loads log event data from HDFS location,
    extracts JSON data.
